...
//to store all the alarms being set in array;
const alarmList = [];

//starting count as 1;

//inorder to play alarm audio at correct time;
...
//to ewmove an alarm from list and webpage when "Delete Alarm" event is placed;
